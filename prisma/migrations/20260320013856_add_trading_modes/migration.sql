...
CREATE TABLE "new_RiskRule" (
    ...
    "activeMode" TEXT NOT NULL DEFAULT 'SAFE',
    ...
    "minConfidence" INTEGER NOT NULL DEFAULT 65
);
INSERT INTO "new_RiskRule" ("createdAt", "id", "isActive", "leverageLargeCap", "leverageLowCap", "leverageMidCap", "maxDailyLossPct", "maxDrawdownPct", "maxLeverage", "maxLeverageLarge", "maxLeverageLow", "maxLeverageMid", "maxOpenPositions", "maxPositionSizePct", "maxRiskPerTradePct", "maxWeeklyLossPct", "minProfitTargetPct", "riskPctLargeCap", "riskPctLowCap", "riskPctMidCap") SELECT "createdAt", "id", "isActive", "leverageLargeCap", "leverageLowCap", "leverageMidCap", "maxDailyLossPct", "maxDrawdownPct", "maxLeverage", "maxLeverageLarge", "maxLeverageLow", "maxLeverageMid", "maxOpenPositions", "maxPositionSizePct", "maxRiskPerTradePct", "maxWeeklyLossPct", "minProfitTargetPct", "riskPctLargeCap", "riskPctLowCap", "riskPctMidCap" FROM "RiskRule";
DROP TABLE "RiskRule";
